  ...
  return (
    <Box sx={{backgroundColor:"black"}}>
      ...
      <Typography variant="h6" sx={{ color: "white",m:3 }}>
        ...
        matchdomaren och godkännas innan varje match. 
        </li>
        <li>
        §2. Vilken av de två
        ...
        Vid tveksamma fall avgör matchdomaren utifall om-middling skall ske. 
        </li>
        <li>
        §3.
        ...
        lossnar, missar tavlan eller fastnar i andra pilar räknas inte. 
        </li>
        <li>
        §5. De
        båda kastarna turas om att avverka sina kastomgångar och reducerar
        därmed sina respektive poängsummor. 
        </li>
        <li>
        ...
        Spelaren står då kvar på den tidigare poängsumman. 
        </li>
        <li>
        §7. Från och med den 
        ...
        första, andra eller tredje pilen i en kastomgång. 
        </li>
        <li>
        §8. Om en spelare går
        ...
        ut och spelaren står kvar på sin tidigare poäng. 
        </li>
        <li>
        ...
        avlägsnas för tidigt döms kastet bort. 
        </li>
        <li>
        ...
        det står 1-1 i ben avgörs matchen via middling. 
        </li>
        <li>
        §14. Det är absolut
        förbjudet att kasta pilar på något annat än matchtavlan. 
        </li>
        <li>
        §15. Stilpriset
