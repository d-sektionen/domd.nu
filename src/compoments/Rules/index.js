    ...
    <Root container sx={{ pt: { xs: 7, md: 11 } }} align="left">
      ...
      >
        ...
        >
          ...
          <li>
            §2. Vilken av de två motståndarna som ska börja avgörs genom
          ...
          <li>
            §7. Från och med den första omgången då en spelare inleder med 50
          ...
          <li>
            §14. Det är absolut förbjudet att kasta pilar på något annat än
            matchtavlan. <br />
            <br />
          </li>
          <li>
            §15. Stilpriset bedöms och bestäms enhälligt av D-Group och
          ...
          <li>
            §16. ÖverDomaren™ förbehåller sig rätten att diskvalificera lag som
            inte följer reglerna eller på annat sätt beter sig illa. <br />
            <br />
          </li>
          <li>
            §17. ÖverDomaren™ förbehåller sig rätten att ändra reglerna om denne
